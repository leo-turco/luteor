...
I'm a `25` year old (`⏳ next birthday in 315 days ⌛️`) French 🥐 **full stack web developer** 👨‍💻 with a versatile profile forged by a **holistic vision of the digital professional world**, and convinced of the importance of **curiosity** and **continuous learning**.
...
Last updated on `1/2/2024` ~~by hand~~ **by my homemade `terrific` bot** 🤖.
