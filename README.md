...
I'm a `26` year old (`⏳ next birthday in 312 days ⌛️`) French 🥐 **full stack web developer** 👨‍💻 with a versatile profile influenced by a **holistic vision of the professional world**, and convinced of the importance of **curiosity** and **continuous learning**.
...
Last updated on `1/4/2025` ~~by hand~~ **by my homemade `extraordinary` bot** 🤖.
