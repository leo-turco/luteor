...
I'm a `25` year old (`⏳ next birthday in 240 days ⌛️`) French 🥐 **full stack web developer** 👨‍💻 with a versatile profile influenced by a **holistic vision of the professional world**, and convinced of the importance of **curiosity** and **continuous learning**.
...
Last updated on `3/17/2024` ~~by hand~~ **by my homemade `impressive` bot** 🤖.
