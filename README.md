...
I'm a `25` year old (`⏳ next birthday in 333 days ⌛️`) French 🥐 **full stack web developer** 👨‍💻 with a versatile profile forged by a **holistic vision of the digital professional world**, and convinced of the importance of **curiosity** and **continuous learning**.
...
Last updated on `12/15/2023` ~~by hand~~ **by my homemade `impressive` bot** 🤖.
